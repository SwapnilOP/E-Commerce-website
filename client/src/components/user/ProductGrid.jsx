        ...
        {products.map((product) => (
          ...
          >
            ...
            <button
              ...
              className="absolute top-3 right-3 z-20 text-gray-600 border rounded-full p-2 bg-amber-50 hover:text-pink-600"
            >
              <FaHeart />
            </button>
            ...
            <div className="p-4 text-center">
              ...
              <button
                onClick={(e) => e.preventDefault()} // prevent navigation
                className="mt-3 w-full bg-purple-700 text-white py-2 rounded flex items-center justify-center gap-2"
              >
                <FaShoppingCart />
                Add to Cart
              </button>
